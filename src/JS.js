...
function nutsAndBolts(cost, damage, range, attackSpeed, xCoord, yCoord, upgraded, targetIndice, isShooting, bulletArr, baseDamage){
	...
	this.baseDamage = 15;
	this.info = "Nuts do basic damage and if this tower shoots a bolt, it will crit for four times the damage.";
}
...
//Stage 4
stageWave[3][0] = ["redSkeleton", "redSkeleton", "basicSkeleton", "basicSkeleton", "basicSkeleton", "witch"];
